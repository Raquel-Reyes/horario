...
<head>
    ...
    <link rel="stylesheet" href="./static/estilosProfesor.css">   
    <link rel="stylesheet" href="./static/estilos.css">
</head>
<body>
    <img id="full-screen-background-image" src="./static/fondo.jpg" alt="full screen backgroung image">
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <button class="btn" type="submit" name="nuevo_docente">Guardar Docente</button>
            <br>
            <br>
            <a class="btn" href="registro.php" type="submit" >Regresar</a>
